...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ItemsDB; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
 ...
 */
var ItemsDB = /** @class */ (function () {
    function ItemsDB(storage, defaults) {
        this.storage = storage;
        this.ITEMS_KEY = '_items';
        this._defaults = defaults;
    }
    ItemsDB.prototype.load = function () {
        var _this = this;
        return this.storage.get(this.ITEMS_KEY).then(function (value) {
            if (value) {
                _this.items = value;
    ...
    ItemsDB.prototype._mergeDefaults = function (defaults) {
    ...
    ItemsDB.prototype.merge = function (items) {
        for (var k in items) {
            this.items[k] = items[k];
        }
        return this.save();
    };
    ItemsDB.prototype.setValue = function (key, value) {
        this.items[key] = value;
        return this.storage.set(this.ITEMS_KEY, this.items);
    };
    ItemsDB.prototype.setAll = function (value) {
        return this.storage.set(this.ITEMS_KEY, value);
    };
    ItemsDB.prototype.getValue = function (key) {
        return this.storage.get(this.ITEMS_KEY)
            .then(function (settings) {
            return settings[key];
        });
    };
    ItemsDB.prototype.save = function () {
        return this.setAll(this.items);
    };
    Object.defineProperty(ItemsDB.prototype, "allItems", {
        get: function () {
            return this.items;
        },
        enumerable: true,
...
//# sourceMappingURL=itemsDB.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OrderDB; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_storage__ = __webpack_require__(45);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
 ...
 * A simple settings/config class for storing key/value pairs with persistence.
 */
var OrderDB = /** @class */ (function () {
    function OrderDB(storage, defaults) {
        this.storage = storage;
        this.ORDER_KEY = '_orders';
        this._defaults = defaults;
        console.log('Order DB Initialized.');
    }
    OrderDB.prototype.load = function () {
        var _this = this;
        return this.storage.get(this.ORDER_KEY).then(function (value) {
            if (value) {
                _this.orders = value;
                return _this._mergeDefaults(_this._defaults);
            }
    ...
    OrderDB.prototype._mergeDefaults = function (defaults) {
        for (var k in defaults) {
            if (!(k in this.orders)) {
    ...
    OrderDB.prototype.merge = function (items) {
        for (var k in items) {
            this.orders[k] = items[k];
        }
        return this.save();
    };
    OrderDB.prototype.setValue = function (key, value) {
        this.orders[key] = value;
        return this.storage.set(this.ORDER_KEY, this.orders);
    };
    OrderDB.prototype.setAll = function (value) {
        return this.storage.set(this.ORDER_KEY, value);
    };
    OrderDB.prototype.getValue = function (key) {
        return this.storage.get(this.ORDER_KEY)
            .then(function (settings) {
            return settings[key];
        });
    };
    OrderDB.prototype.save = function () {
        return this.setAll(this.orders);
    };
    Object.defineProperty(OrderDB.prototype, "allItems", {
        get: function () {
            return this.orders;
        },
        enumerable: true,
...
/* unused harmony export provideItems */
/* unused harmony export provideOrder */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_items_itemsDB__ = __webpack_require__(224);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_order_OrderDB__ = __webpack_require__(227);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
function provideSettings(storage) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_11__providers__["c" /* Settings */](storage, {
        ...
        option2: '800',
        option3: '3',
        option4: 'Ravindra Kumar'
    });
}
function provideItems(storage) {
    /**
     * The Settings provider takes a set of default settings for your app.
     *
     * You can add new settings options at any time. Once the settings are saved,
     * these values will not overwrite the saved values (this can be done manually if desired).
     */
    return new __WEBPACK_IMPORTED_MODULE_13__providers_items_itemsDB__["a" /* ItemsDB */](storage, [
        {
            "name": "Cofee",
            "profilePic": "assets/img/speakers/bear.jpg",
            "about": "Cofee",
...
function provideOrder(storage) {
     ...
     * these values will not overwrite the saved values (this can be done manually if desired).
     */
    return new __WEBPACK_IMPORTED_MODULE_14__providers_order_OrderDB__["a" /* OrderDB */](storage, '');
}
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_13__providers_items_itemsDB__["a" /* ItemsDB */], useFactory: provideItems, deps: [__WEBPACK_IMPORTED_MODULE_6__ionic_storage__["b" /* Storage */]] },
                { provide: __WEBPACK_IMPORTED_MODULE_14__providers_order_OrderDB__["a" /* OrderDB */], useFactory: provideOrder, deps: [__WEBPACK_IMPORTED_MODULE_6__ionic_storage__["b" /* Storage */]] },
...
var MyApp = /** @class */ (function () {
    function MyApp(translate, platform, settings, config, statusBar, splashScreen) {
        ...
        this.pages = [
            ...
            { title: 'New Order', component: 'OrderPage' },
            { title: 'Dashboard', component: 'CardsPage' },
            { title: 'Reports', component: 'ContentPage' },
            // { title: 'Login', component: 'LoginPage' },
            // { title: 'Signup', component: 'SignupPage' },
            // { title: 'Menu', component: 'MenuPage' },
            { title: 'Manage Items', component: 'ListMasterPage' },
