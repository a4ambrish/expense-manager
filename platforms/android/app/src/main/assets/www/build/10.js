...
var ItemCreatePage = /** @class */ (function () {
    function ItemCreatePage(navCtrl, viewCtrl, formBuilder, camera) {
        ...
        this.form = formBuilder.group({
            ...
            about: [''],
            rate: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["f" /* Validators */].required]
        });
